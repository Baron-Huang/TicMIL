...
if __name__ == "__main__":
    ...
    gpu_device = 0
    mode_stats = 'training'
    weight_path = '/data/HP_Projects/TicMIL/Weights_Result_Text/WSI/Other_SOTA/FRMIL.pth'
    testing_weights_path = r'/data/HP_Projects/TicMIL/Weights_Result_Text/WSI/Other_SOTA/FRMIL.pth'
