...
from Models.TicMIL_model_modules import (TicMIL_for_ablation, TicMIL_Parallel_Feature,
                                         TicMIL_Parallel_Head)
from Utils.fit_functions import testing_for_pacmil_parallel, training_for_pacmil_parallel
...
if __name__ == '__main__':
    ...
    paras.add_argument('--batch_size', type=int, default=3)
    ...
    paras.add_argument('--train_read_path', type=str,
                default=r'/root/autodl-tmp/TicMIL/Datasets/Cervix/New_Bags/Train')
    paras.add_argument('--test_read_path', type=str,
                default=r'/root/autodl-tmp/TicMIL/Datasets/Cervix/New_Bags/Test')
    paras.add_argument('--val_read_path', type=str,
                default=r'/root/autodl-tmp/TicMIL/Datasets/Cervix/New_Bags/Test')

    paras.add_argument('--weights_save_path', type=str,
                default=r'/root/autodl-tmp/TicMIL/Weights_Result_Text/WSI/Cervix_WSI_Baseline_20240817.pth')
    paras.add_argument('--test_weights_path', type=str,
                default=r'/root/autodl-tmp/TicMIL/Weights_Result_Text/WSI/Cervix_WSI_SOTA_20240813.pth')


    ### Parallel save
    paras.add_argument('--weights_save_feature', type=str,
                        default=r'/root/autodl-tmp/TicMIL/Weights_Result_Text/WSI/TicMIL_feature_20250409.pth')
    paras.add_argument('--weights_save_head', type=str,
                        default=r'/root/autodl-tmp/TicMIL/Weights_Result_Text/WSI/TicMIL_head_20250409.pth')
    ...
    paras.add_argument('--pretrained_weights_path', type=str,
                default=r'/root/autodl-tmp/TicMIL/Weights/SwinT/swin_tiny_patch4_window7_224_22k.pth')
    ...
    if args.data_parallel == False:
        ...
        ticmil_head = TicMIL_Parallel_Head(base_model=swinT_base, class_num=args.class_num, model_stats=args.run_mode,
    ...
    if args.run_mode == 'train':
        ...
        if args.data_parallel == False:
            training_for_pacmil_parallel(mil_net=ticmil_net, train_loader=train_loader, val_loader=val_loader,
                        test_loader=test_loader, lr_fn='vit', epoch=args.epochs,
    ...
    if args.run_mode == 'test':
        ...
        if args.data_parallel == False:
            ...
            testing_for_pacmil_parallel(test_model=ticmil_net, train_loader=test_loader, val_loader=val_loader,
