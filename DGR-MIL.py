...
if __name__ == "__main__":
    ...
    mode_stats = 'training'
    dgrmil_mode = 'linear'
    weight_path = '/data/HP_Projects/TicMIL/Weights_Result_Text/WSI/Other_SOTA/DGR_MIL.pth'
    testing_weights_path = r'/data/HP_Projects/TicMIL/Weights_Result_Text/WSI/Other_SOTA/DGR_MIL.pth'
    ...
    dgrmil_net = DGRMIL(768, num_classes=num_classes, attn_mode=dgrmil_mode, dropout_node=0.1)
    ...
    if mode_stats == 'training':
        training_for_dgrmil(mil_net=dgrmil_net, train_loader=train_loader, val_loader=val_loader, test_loader=test_loader,
