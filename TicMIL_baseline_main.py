...
if __name__ == '__main__':
    ...
    paras.add_argument('--train_read_path', type=str,
                default=r'/data/HP_Projects/TicMIL/Datasets/Cervix/Cervix_MIL_961/Train')
    paras.add_argument('--test_read_path', type=str,
                default=r'/data/HP_Projects/TicMIL/Datasets/Cervix/Cervix_MIL_961/Test')
    ...
    paras.add_argument('--weights_save_feature', type=str,
                        default=r'/data/HP_Projects/TicMIL/Weights_Result_Text/WSI/Baseline_Feature.pth')
    paras.add_argument('--weights_save_head', type=str,
                        default=r'/data/HP_Projects/TicMIL/Weights_Result_Text/WSI/Baseline_Head.pth')
