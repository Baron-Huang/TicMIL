...
def testing_for_dgrmil(test_model=None, train_loader=None, val_loader=None, test_loader=None, gpu_device=0,
    ...
    val_acc, val_loss, _, _ = view_results_for_dgrmil(mil_net=test_model, train_loader=val_loader, data_parallel=False,
                                                      loss_fn=loss_fn, proba_mode=proba_mode, gpu_device=gpu_device,
                                                      proba_value=proba_value, class_num=class_num, bags_stat=bags_stat)
    ...
    # print('########################## auc results #########################')
    print(np.reshape(label_proba_sum, (label_proba_sum.shape[0]*label_proba_sum.shape[1])),
